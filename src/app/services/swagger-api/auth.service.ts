...
export class AuthService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public authRefreshTokensPost(body: Body3, observe?: 'body', reportProgress?: boolean): Observable<AuthTokens>;
    public authRefreshTokensPost(body: Body3, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AuthTokens>>;
    public authRefreshTokensPost(body: Body3, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AuthTokens>>;
    public authRefreshTokensPost(body: Body3, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<AuthTokens>('post',`${this.basePath}/auth/refresh-tokens`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
