...
export class UserService {
     ...
     */
    public meGet(observe?: 'body', reportProgress?: boolean): Observable<User>;
    public meGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<User>>;
    public meGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<User>>;
    public meGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<User>('get',`${this.basePath}/me`,
            {
