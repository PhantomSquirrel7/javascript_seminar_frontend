...
@Component({
  selector: 'app-find-partner-class-view-results',
  templateUrl: './find-partner-class-view-results.component.html',
  styleUrls: ['./find-partner-class-view-results.component.less']
})
export class FindPartnerClassViewResultsComponent {
